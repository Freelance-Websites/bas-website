class Header extends HTMLElement {
  connectedCallback() {
    const { active, root } = this.dataset;

    this.innerHTML = `
      <header class="flex items-baseline justify-between">
        <a href="${root ? root : './'}index.html" class="transition ease-in-out duration-100 hover:opacity-70">
          <svg width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-gray-900">
