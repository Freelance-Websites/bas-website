const Header = ({ active }) => {
  return (
    <header className="flex items-baseline justify-between">
      <a href="/" className="transition ease-in-out duration-100 hover:opacity-70">
      ...
      <ul className="flex items-baseline">
        <li className="pr-2 md:pr-4">
          <a href="/projects" className={`${active === 'projects' ? 'underline' : ''} hover:underline underline-offset-4 font-sans uppercase text-xs text-gray-900 tracking-widest`} data-text-en="Projects" data-text-es="Proyectos">
            Proyectos
          </a>
        </li>
        <li className="pr-2 md:pr-4">
          <a href="/contact" className={`${active === 'contact' ? 'underline' : ''} hover:underline underline-offset-4 font-sans uppercase text-xs text-gray-900 tracking-widest`} data-text-en="Contact" data-text-es="Contacto">
            Contacto
          </a>
        </li>
        <li>
          <button id="language-selector" data-language="EN" className="hover:underline underline-offset-4 font-sans uppercase text-xs text-gray-900 tracking-widest">
            EN
          </button>
        </li>
      </ul>
